					        ...
					        if($query_run)
					          {
					            ...
					            {
											$query_new=mysqli_query($con,"INSERT log_in set username='$username', password='$password', name= 'angela',email='$email',date_joined = 'CURRENT_TIMESTAMP', patientid='$pid', admin=0,staff=0,caregiver=1");
							    				if($query_new)
												{
