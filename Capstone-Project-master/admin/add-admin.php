					        ...
					        if($query_run)
					          {
					            ...
					            {
                                                $query_new=mysqli_query($con,"INSERT log_in set username='$username', password='$password', name= 'angela',email='$email',date_joined = 'CURRENT_TIMESTAMP', patientid='0', admin=1,staff=0,caregiver=0");
												if($query_new)
												{
